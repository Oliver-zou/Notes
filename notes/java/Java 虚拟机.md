...
每个 Java 方法在执行的同时会创建一个栈帧用于存储局部变量表(方法的参数or内部变量)、操作数栈、常量池引用等信息。从方法调用直至执行完成的过程，对应着一个栈帧在 Java 虚拟机栈中入栈和出栈的过程。一旦超出作用域，立即从栈内存中消失。
...
存储.class相关的信息，包含方法的信息：用于存放已被加载的类信息、常量、静态变量、即时编译器编译后的代码等数据。
...
<div align="center"> <img src="../../pics/9422c251-2676-4f4b-8b3b-d67f2e9daffc.png" width="500px"> </div><br>数组内存示意图

<div align="center"> <img src="../../pics/62af9019-9b6f-4596-ad4b-880f33e9dd75.png" width="500px"> </div><br>只有一个对象的内存示意图

<div align="center"> <img src="../../pics/44cbdf34-b624-4075-8c90-2cfd3ee90198.png" width="500px"> </div><br>两个引用指向同一个对象的内存示意图
