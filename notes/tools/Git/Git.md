...
Git 会使用 <<<<<<< ，======= ，>>>>>>> 标记出不同分支的内容，只需要把不同分支中冲突部分修改成一样就能解决冲突。HEAD 到 ======= 里面的本次commit的内容
...
不需要全部自己编写，可以到 [https://github.com/github/gitignore](https://github.com/github/gitignore) 中进行查询模板。
...
- [合并分支](https://www.cnblogs.com/ycyh1314/p/11640968.html)

- 执行完commit后，撤回commit

  **git reset --soft HEAD^**

  注：仅仅是撤回commit操作，改动仍保留
...
- [Git Commit规范](https://www.jianshu.com/p/e91b150a0e82)
